...
@model("meta_gru4rec_gau", MetaType.ModelBuilder)
class GRU4Rec(nn.Module):
    ...
    def __init__(self, model_conf):
        ...
        self.mu = nn.Parameter(torch.tensor(9.0, requires_grad=True))
        self.sigma = nn.Parameter(torch.tensor(1.5, requires_grad=True))
    ...
    def forward(self, features):
        ...
        pos_weights = torch.exp(-((positions - self.mu)**2) /
                                (2 * self.sigma**2))
